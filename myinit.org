...
* Company
  #+BEGIN_SRC emacs-lisp
	...
	;; (defvar company-general-backends '((company-files 
	;; 					company-dabbrev)
	;; 				       (company-abbrev company-dabbrev)))

	;; company-dabbrev and company-files are very useful. So, adjust default backends
	(defvar company-general-backends '(company-dabbrev compnay-files company-bbdb company-eclim company-semantic company-clang company-xcode company-cmake company-capf
							   (company-dabbrev-code company-gtags company-etags company-keywords)
							   company-oddmuse company-dabbrev))
     ...
     (add-hook 'org-mode-hook #'(lambda ()
				  (progn
				    ...
				    (defun my-org-confirm-babel-evaluate (lang body)
				      (not (member lang '("emacs-lisp" "lisp" "clojure" "python" "R" "C"))))
