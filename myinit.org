...
** highlight-indentation
   #+BEGIN_SRC emacs-lisp
	 ...
	 ;; see: https://stackoverflow.com/questions/16048231/how-to-enable-a-non-global-minor-mode-by-default-on-emacs-startup
	 ...
	 ;; (add-hook 'c++-mode-hook #'highlight-indentation-mode)
	 ;; (add-hook 'R-mode-hook #'highlight-indentation-mode)
...
** make code-block could be executed in org-mode
     ...
     (add-hook 'org-mode-hook #'(lambda ()
				  (progn
				    ...
				    (defun my-org-confirm-babel-evaluate (lang body)
				      (not (member lang '("emacs-lisp" "lisp" "clojure" "python" "R" "C" "latex" "dot" "plantuml"))))
   ...
   #+RESULTS:
   : ((uml . src plantuml) (dot . src dot) (lt . LaTeX) (http . src http) (js . src js) (r . src R) (clojure . src clojure) (sh . src sh) (lisp . src lisp) (el . src emacs-lisp) (py . src python) (py3 . src python3) (a . export ascii) (c . center) (C . comment) (e . example) (E . export) (h . export html) (l . export latex) (q . quote) (s . src) (v . verse))
