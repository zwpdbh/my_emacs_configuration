...
** Scheme
   #+begin_src emacs-lisp
	 ...
	 ;; (defun my-reset-eval-for-scheme ()
	 ;;   (eval-after-load 'geiser
	 ;; 	'(define-key geiser-mode-map (kbd "C-c C-c") 'eval-last-sexp)))
	 ;; (add-hook 'geiser-mode-hook 'my-reset-eval-for-scheme)
