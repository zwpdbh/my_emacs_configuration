...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (slime-autoloads typescript treemacs-magit treemacs-icons-dired auto-package-update dirtree slime-company json-mode xref-js2 js-refactor js2-mode flycheck-yamllint nlinum htmlize emacs-htmlize yaml-mode treemacs-projectile treemacs-evil treemacs ac-slime racket-mode slime macrostep elisp-slime-nav ensime which-key use-package try paredit material-theme leuven-theme indent-guide exec-path-from-shell counsel auto-complete ace-window))))
(custom-set-faces
