...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (lsp-treemacs helm-lsp company-anaconda anaconda-mode python-mode eglot ycmd clang-format cmake-mode gradle-mode meghanada org-mode prettier-js sly company-flx cmake-ide t: helm-gtags ivy-hydra jedi helm-cider helm aggressive-indent rainbow-delimiters cider base16-theme gruvbox-theme zenburn-theme yaml-mode xref-js2 which-key web-mode use-package try treemacs-projectile treemacs-magit treemacs-icons-dired treemacs-evil tide spacemacs-theme solarized-theme slime-company racket-mode paredit nlinum neotree material-theme leuven-theme json-mode js2-refactor indent-tools indent-guide htmlize flycheck-yamllint exec-path-from-shell esup ensime elpy elisp-slime-nav dirtree counsel company-tern autopair auto-package-update adaptive-wrap ac-slime))))
(custom-set-faces
