...
** Scheme
   #+begin_src emacs-lisp
     ...
     (use-package repl-toggle
       ...
       (setq rtog/mode-repl-alist '((scheme-mode . geiser) (emacs-lisp-mode . ielm) (js2-mode . nodejs-repl) (python-mode . elpy-shell-switch-to-shell)))
       :after (scheme-mode)
       :ensure t)
   #+end_src

   #+RESULTS:
   : ((scheme-mode . geiser) (emacs-lisp-mode . ielm) (js2-mode . nodejs-repl) (python-mode . elpy-shell-switch-to-shell))
